...
def calculate_bond_price(yield_to_maturity,
                         face_value,
                         coupon_rate,
                         years,
                         num_periods_year):
    """Calculates a single bond price for a given yield to maturity with predefined 
    (semiannual) compounding. Calculated the sum of the present values of all coupon 
    payments and the present value of the principal payment at maturity. The bond cash 
    flows are discounted at the yield to maturity given to the method.  
    """
